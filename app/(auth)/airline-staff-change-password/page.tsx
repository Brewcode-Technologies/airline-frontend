...
export default function AirlineStaffChangePasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => router.push('/airline-staff-login'), 2000);
    } catch (err: any) {
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="bg-blue-600 px-6 py-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm">Update your airline staff account password</p>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <p className="text-center text-sm text-gray-500 mt-5">
              <Link href="/airline-staff-login" className="text-blue-600 hover:underline font-medium">← Back to Sign In</Link>
            </p>
          </div>
        </div>
      </div>
